	...
	public void init() {
	 ...
	 public String checkingVoting() {
		 ...
		 if (age<18) {
			 ...
			 return  name+" is "+age+" years old, lives in "+address+" is not elligible for voting . checked on "+verfiedOn;
		}
		 else {
			 return  name+" is "+age+" years old, lives in "+address+" is elligible for voting. checked on "+verfiedOn;
		}
	 }
